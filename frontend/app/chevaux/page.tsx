        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold">Base de données des Chevaux</h1>
            </div>
            <p className="text-xl text-primary-100">
              Statistiques complètes et historique de performance de tous les chevaux de courses
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          {loading ? (
            ...
            <div className="text-center py-12 bg-white rounded-xl shadow-lg">
              ...
              <p className="text-xl text-gray-600">Aucun cheval trouvé</p>
            </div>
          ) : (
            <>
              <div className="grid gap-4">
                {horses.map((horse) => (
                  <Link
                    key={horse.id}
                    href={`/cheval/${encodeURIComponent(horse.name)}`}
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                          <div className="flex items-center gap-1">
                            ...
                            <span>{horse.totalRaces} courses</span>
                          </div>
                          <div className="flex items-center gap-1">
                            <Trophy className="w-4 h-4 text-yellow-500" />
                            <span>{horse.wins} victoires</span>
                          </div>
                          <div className="flex items-center gap-1">
                            <Target className="w-4 h-4 text-blue-500" />
                            <span>{horse.podiums} podiums</span>
                          </div>
                        </div>
                      </div>
