          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed">
                La course <strong>{race.name}</strong> se déroule à l'hippodrome de <strong>{race.hippodrome}</strong> 
                dans le cadre de la réunion {race.reunionNumber}. Cette épreuve de <strong>{race.discipline}</strong> sur 
                une distance de <strong>{race.distance} mètres</strong> offre une allocation de{' '}
